     ...
     */
    @Disabled
    @Autonomous(name = "AUTONOM CONCURS REGIO", group = "Concept")
    
    public class Autonom_Regionalav1 extends LinearOpMode {
                ...
                if (K == 4) {
                   ...
                   /// Rotire_GyroLELv1(0);
                    ...
                    Fata(1, 4000);
                        ...
                        BratWobble.setPosition(0.8);///coborare
                         sleep(1500);
