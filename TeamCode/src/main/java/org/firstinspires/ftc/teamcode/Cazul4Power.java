...
@Disabled
@Autonomous(name="Cazul4Power", group="chad")
public class Cazul4Power extends LinearOpMode {
    //
    ...
    public void runOpMode(){
        ...
        waitForStartify();
        //
        moveToPosition(49.4, 1);
	//
	strafeToPosition(-8.8, 1.0);
	//
	strafeToPosition(-7.4, 1.0);
	//
	moveToPosition(57.8, 1);
	//
	strafeToPosition(36.6, 1.0);
	//
	moveToPosition(-89.6, 1);
	//
	moveToPosition(36, 1);
	//
	moveToPosition(53.6, 1);
	//
	moveToPosition(-42.2, 1);
	//
    }
    //
    /*
