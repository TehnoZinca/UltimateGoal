...
public class Camera_Detection extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (tfod != null) {
            ...
            tfod.setZoom(1.78, 3);/// 3-1.78 //1 1
            //am amplificat imaginea cu 2.5.
            //oriece val sub 2.5 nu detecteaza quadul la 62 cm
        }
    ...
    private void initTfod() {
        ...
        tfodParameters.minResultConfidence = 0.7f;//0.7
        //am scazut minResultConfidence de la o.8f la 0.4f ca sa imi detecteze un singur inel la o distanta de 62 cm
